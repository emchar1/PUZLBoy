...
class HowToPlayTableView: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    var terrainItems: [HowToPlayModel] = [
        ...
        HowToPlayModel(image: "partytile", title: "Rainbow", requiredLevel: Level.partyMinLevelRequired + 1,
                       description: "These tiles don't take up any moves and were created for your enjoyment. Run around to your heart's content!"),
    ...
    var overlayItems: [HowToPlayModel] = [
        ...
        HowToPlayModel(image: "gemparty", title: "Party Gem", requiredLevel: Level.partyMinLevelRequired + 1,
