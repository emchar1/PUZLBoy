...
class HowToPlayTableView: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    var terrainItems: [HowToPlayModel] = [
        ...
        HowToPlayModel(image: "partytile", title: "Rainbow", requiredLevel: Level.partyMinLevelRequired + 1,
                       description: "These party panels don't take up any moves and show up every 50 levels. Run around to your heart's content!"),
    ...
    var overlayItems: [HowToPlayModel] = [
        ...
        HowToPlayModel(image: "partyGem", title: "Party Gem", requiredLevel: Level.partyMinLevelRequired + 1,
                       description: "Collect party gems to earn special prizes and bonuses, like extra lives. They're sooo shiny!"),
        HowToPlayModel(image: "partyGemTriple", title: "Party Gem Multipliers", requiredLevel: Level.partyMinLevelRequired + 1,
                       description: "These multipliers add to the party gems you've already collected. ...and they're even SHINIER!"),
