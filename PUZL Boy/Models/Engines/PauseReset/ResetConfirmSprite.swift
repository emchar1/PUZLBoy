...
class ResetConfirmSprite: SKNode {
    ...
    override init() {
        ...
        confirmButton = DecisionButtonSprite(text: "RESTART",
                                             ...
                                             iconImageName: nil)
        confirmButton.position = CGPoint(x: -K.ScreenDimensions.iPhoneWidth / 4, y: -K.ScreenDimensions.iPhoneWidth / 8)
        confirmButton.name = "confirmButton"
        
        cancelButton = DecisionButtonSprite(text: "GO BACK",
                                            color: UIColor(red: 9 / 255, green: 132 / 255, blue: 227 / 255, alpha: 1.0),
                                            iconImageName: nil)
        cancelButton.position = CGPoint(x: K.ScreenDimensions.iPhoneWidth / 4, y: -K.ScreenDimensions.iPhoneWidth / 8)
        ...
        titleLabel.position = CGPoint(x: 0, y: K.ScreenDimensions.iPhoneWidth / 4 - 20)
        ...
        messageLabel.position = CGPoint(x: 0, y: titleLabel.position.y - (UIDevice.isiPad ? 150 : 100))
