...
class ChatEngine {
    ...
    private func adjustBrightnessForMagmoorScary() {
...
extension ChatEngine {
    ...
    private func playDialogueAgeOfBalance(level: Int, anyValue: Any?, completion: ((Cutscene?) -> Void)?) {
        ...
        case -1006:
            delegateCatwalk?.flashRedCatwalk(message: "Turn back now...", secondaryMessages: ["Turn back!", "Turn back!", "Turn back!", "Go away!", "Leave!", "Get out!", "Be gone!", "Not welcome here.", "Trespasser!", "Turn back!", "Turn back!", "Turn back!", "Go away!", "Leave!", "Get out!", "Be gone!", "Not welcome here.", "Trespasser!"]) { [weak self] in
                self?.handleDialogueCompletion(level: level, completion: completion)
            }
        case -1010:
            delegateCatwalk?.flashRedCatwalk(message: "You're going to regret it...", secondaryMessages: ["Regret...", "Failure!", "Disappointment.", "You'll regret it.", "Loser.", "Game Over!", "You lose.", "Disgrace!", "Shame!", "Guilt.", "Dishonor.", "Lose.", "FAIL", "Regret...", "Failure!", "Disappointment.", "You'll regret it.", "Loser.", "Game Over!", "You lose.", "Disgrace!", "Shame!", "Guilt.", "Dishonor.", "Lose.", "FAIL"]) { [weak self] in
        ...
        case -1017:
            ...
            sendChatArray(shouldSkipDim: true, items: [
                ...
                self?.delegateCatwalk?.despawnPrincessCatwalk()
        ...
        case -1036:
            ...
            sendChatArray(shouldSkipDim: true, items: [
                ...
                ChatItem(profile: .statue1, chat: "Next, you'll need something to evade the Mad Mystic's swift attacks....."),
                ChatItem(profile: .statue1, chat: "Here, take this. May your feet glide effortlessly across any terrain. Including lava!") { [weak self] in
                    self?.hideFFButton()
                ...
                ChatItem(profile: .statue1, chat: "And lastly... this. May it grant you everlasting protection against the forces of evil!"),
                ChatItem(profile: .hero, imgPos: .left, chat: "................."),
                ChatItem(profile: .statue1, chat: "Though it may guard against fireballs and other projectiles, it won't hold up to explosive force....... What's the matter?"),
                ChatItem(profile: .hero, imgPos: .left, chat: "Oh, nothing. It's just— uh, isn't that a girl's shield?"),
                ...
                ChatItem(profile: .hero, imgPos: .left, chat: "General Minerva.. a girl."),
                ChatItem(profile: .statue1, chat: "Armed with nothing but her trusty aegis, this shield absorbed all their evil, dark magic and ✨BURST✨ into a dazzling spectacle of lights and color!🌈"),
                ChatItem(profile: .hero, imgPos: .left, chat: "Lovely story. You know what.. The sword and boots will do just fine—"),
                ChatItem(profile: .merton, chat: "'Tis an illustrious piece of equipment, dear boy. Possesses neither male nor female attributes. It is.. oh, what do your people call it again? Ah! Non-binary."),
        ...
        case -1051:
            delegateCatwalk?.exitCatwalk { [weak self] in
                guard let self = self else { return }
        ...
        case -150:
            ...
            sendChatArray(items: [
                ...
                ChatItem(profile: .trainer, imgPos: .left, chat: "⚡️MAGIC SPELL!!!⚡️") { [weak self] in
        ...
        case -250:
            ...
            sendChatArray(items: [
                ...
                delegate?.despawnTrainer(to: nil)
        ...
        case 1:
            ...
            sendChatArray(items: [
                ...
                ChatItem(profile: .trainer, chat: "If your move count hits 0, it's game over buddy! Your move count can be found in the upper left corner next to the boot. 👢") { [weak self] in
        ...
        case 51:
            ...
            sendChatArray(items: [
                ...
                ChatItem(profile: .trainer, chat: "Once your health drops to 0, it's lights out! Your health can be found in the upper left next to the heart. 💖") { [weak self] in
        ...
        case 412:
            ...
            sendChatArray(shouldSkipDim: true, items: [
                ...
                ChatItem(profile: .blankhero, chat: "\n\nGuys!! I— right here—") { [weak self] in
                    self?.showFFButton()
                },
            ...
            sendChatArray(shouldSkipDim: true, items: [
                ...
                self?.delegate?.minionAttack(duration: attackDuration) {
                    ...
                    self?.delegate?.spawnElder(minionPosition: spawnPointMinion, positions: [(0, 3), (4, 0), (4, 6)]) {
                        ...
                        self?.sendChatArray(shouldSkipDim: true, items: [
                            ChatItem(profile: .allelders, startNewChat: true, chat: "⚡️BEGONE, CREATURE!!!⚡️") {
                                self?.showFFButton()
                            }
                        ]) {
