...
extension UIDevice {
    static let modelInfo: (name: String, ratio: CGFloat, topSafeArea: CGFloat, bottomSafeArea: CGFloat) = {
        ...
        func mapToDevice(identifier: String) -> (name: String, ratio: CGFloat, topSafeArea: CGFloat, bottomSafeArea: CGFloat) { // swiftlint:disable:this cyclomatic_complexity
            ...
            case "iPad13,18", "iPad13,19":                        return ("iPad (10th generation)", 4/3, safe.top, safe.btm)
            ...
            case "iPad13,1", "iPad13,2":                          return ("iPad Air (4th generation)", 4/3, safe.top, safe.btm)
            case "iPad13,16", "iPad13,17":                        return ("iPad Air (5th generation)", 4/3, safe.top, safe.btm)
            ...
            case "iPad14,1", "iPad14,2":                          return ("iPad mini (6th generation)", 4/3, safe.top, safe.btm)
            ...
            case "iPad8,9", "iPad8,10":                           return ("iPad Pro (11-inch) (2nd generation)", 4/3, safe.top, safe.btm)
            case "iPad13,4", "iPad13,5", "iPad13,6", "iPad13,7":  return ("iPad Pro (11-inch) (3rd generation)", 4/3, safe.top, safe.btm)
            case "iPad14,3", "iPad14,4":                          return ("iPad Pro (11-inch) (4th generation)", 4/3, safe.top, safe.btm)
