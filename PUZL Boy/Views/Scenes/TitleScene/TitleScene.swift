...
class TitleScene: SKScene {
    ...
    private func animateSprites() {
        ...
        AudioManager.shared.playSound(for: ThemeManager.getAudio(theme: ThemeManager.mainTheme, sound: .title), delay: delayMenu)
    }
...
extension TitleScene: MenuItemLabelDelegate {
    private func startGame(levelSelectNewLevel: Int?) {
        ...
        disableInput = true
        AudioManager.shared.stopSound(for: ThemeManager.getAudio(theme: ThemeManager.mainTheme, sound: .title), fadeDuration: fadeDuration)
